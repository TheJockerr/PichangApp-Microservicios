...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `neversight-skills_feed-java-architect`                                |
| Version    | 1.0.2                                     |
| Author     | NeverSight                                 |
...
java-architect is a specialist skill for designing and implementing enterprise Java systems with Spring Boot 3.x. It provides prescriptive guidance and patterns for microservices, reactive WebFlux stacks, JPA performance tuning, and Spring Security hardening. Use it when building or migrating backend services, implementing cloud-native patterns (service discovery, config, circuit breakers, observability), or choosing between imperative and reactive approaches. Key features include architecture templates, migration checklists to Spring Boot 3, JPA query optimization and batching strategies, reactive backpressure and WebFlux patterns, secure authentication/authorization configurations, testing and CI/CD recommendations, and deployment best practices for Kubernetes and cloud platforms. Core advantages are reduced architectural risk, faster development through proven patterns, improved runtime performance, and stronger security and operational readiness.
...
```bash
npx -y @lobehub/market-cli skills install neversight-skills_feed-java-architect
```
...
npx -y @lobehub/market-cli skills install neversight-skills_feed-java-architect --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install neversight-skills_feed-java-architect --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install neversight-skills_feed-java-architect --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install neversight-skills_feed-java-architect --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install neversight-skills_feed-java-architect --version 1.0.2
```
...
```bash
npx -y @lobehub/market-cli skills rate neversight-skills_feed-java-architect --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment neversight-skills_feed-java-architect -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment neversight-skills_feed-java-architect
```
...
```bash
npx -y @lobehub/market-cli skills comments neversight-skills_feed-java-architect
```
