...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `neversight-learn-skills.dev-spring-boot-expert`                                |
| Version    | 1.0.0                                     |
| Author     | NeverSight                                 |
...
**GitHub:** [NeverSight/learn-skills.dev](https://github.com/NeverSight/learn-skills.dev) — ⭐ 52 | Forks: 11
...
An expert-level Spring Boot skill for designing, implementing, and operating production-grade Java services using the Spring Framework, REST APIs, and microservices patterns. Features include rapid project scaffolding, dependency injection and configuration management, Spring Data JPA and transaction patterns, REST API design (versioning, pagination, HATEOAS), exception handling, validation, and secure endpoints with Spring Security/OAuth2. It covers microservices concerns such as service discovery (Eureka), centralized configuration, resilience patterns (circuit breakers, retries with Resilience4j), messaging and event-driven integration, observability (Actuator, metrics, tracing), containerization (Docker/Kubernetes), and automated testing (unit, integration). Use cases: building scalable APIs, decomposing monoliths, integrating databases and message brokers, and tuning for performance and reliability. Core advantages are production readiness, maintainability, testability, and alignment with modern cloud-native best practices.
...
```bash
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-spring-boot-expert
```
...
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-spring-boot-expert --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-spring-boot-expert --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-spring-boot-expert --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-spring-boot-expert --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-spring-boot-expert --version 1.0.0
```
...
```bash
npx -y @lobehub/market-cli skills rate neversight-learn-skills.dev-spring-boot-expert --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment neversight-learn-skills.dev-spring-boot-expert -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment neversight-learn-skills.dev-spring-boot-expert
```
...
```bash
npx -y @lobehub/market-cli skills comments neversight-learn-skills.dev-spring-boot-expert
```
